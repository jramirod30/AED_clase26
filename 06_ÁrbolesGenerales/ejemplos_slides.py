...
def find_aux[T](gtree: ITree[T], elem: T, p: IPosition[T]) -> IPosition[T] | None:
    """
...
def find[T](gtree: ITree[T], elem: T) -> IPosition[T] | None:
...
def my_breadth[T](gtree: ITree[T]) -> list[IPosition[T]]:
