...
def sum_elems(btree: IBinaryTree[int], p: IPosition[int] | None) -> int:
    """
...
def height[T](btree: IBinaryTree[T], p: IPosition[T] | None) -> int:
    """
    PRE: btree is not empty
...
def existe[T](btree: IBinaryTree[T], p: IPosition[T] | None, elem: T) -> bool:
    """
    PRE: btree is not empty
